	...
	return (
		<div className="flex flex-row w-full h-full bg-gray-900 text-gray-200">
			<NavBar>
				...
				<Link to={`${url}/grades`} className="flex flex-row justify-center group-hover:justify-start group-hover:mr-3 
					hover:bg-purple-800 text-gray-300 p-4 rounded-r-xl">
					<i className="material-icons">fact_check</i>
					<p className="hidden group-hover:block mx-2">Grades</p>
				</Link>
				<Link to={`${url}/attendance`} className="flex flex-row justify-center group-hover:justify-start group-hover:mr-3 
					hover:bg-purple-800 text-gray-300 p-4 rounded-r-xl">
					<i className="material-icons">date_range</i>
					<p className="hidden group-hover:block mx-2">Attendance</p>
				</Link>
