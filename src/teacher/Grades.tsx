...
const GradeData = (props: any) => {
	...
	const onSubmit = async (event: React.FormEvent) => {
		...
		await fetch(`${apiLink}/teachers/assignGrade`, {
			method: 'post',
			credentials: 'include',
			headers: {
				"Content-Type": "application/json",
	...
	return (
		<Form>
			<Label>
				...
				focus:border-purple-500" name="grade">
				...
				<div className="flex flex-col items-stretch w-full">
					...
					<div className="w-full mb-8 bg-gray-100 shadow-xl p-10 rounded-3xl">
						<div className="flex items-center justify-between pb-2 border-b-2 border-gray-300">
							<p className="text-2xl text-blue-900"> Vendos Note </p>
						</div>
